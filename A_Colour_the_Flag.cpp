...
///////////////////////////////////////////////////////////////////////
int check(vector<vector<char>> &mat, int n, int m, vector<vector<char>> &matR)
{
    int f = 1;
    for (int i = 0; i < n; i++)
    {
...
*/
    ...
    while (t--)
    {
        ...
        vector<vector<char>> matW(n, vector<char>(m));
        int f = 0;
        for (int i = 0; i < n; i++)
        {
            if (i == 0)
