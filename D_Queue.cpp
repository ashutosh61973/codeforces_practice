...
///////////////////////////////////////////////////////////////////////
int bin_search(int i, vector<int> &suff, int ele)
{
    int l = i + 1, r = suff.size() - 1;
    int ans = r + 1;
    while (l < r)
    {
        int mid = (l + r + 1) / 2;
...
*/
    ...
    for (int i = 0; i < n; i++)
    {
        auto idx = bin_search(i, suff, v[i]);
        // cout << idx << " ";
        //  auto idx = lower_bound(suff.begin() + i + 1, suff.end(), v[i]) - suff.begin();
        cout << (idx - (i + 1) - 1) << " ";
    }
}
